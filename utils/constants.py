...
CHOSEN_ARCHITECTURE = ARCHITECTURE_D1
MODEL_EPOCHS = 160
MODEL_BATCH_SIZE = 8
...
MODEL_NO_BARLOW_NAME = Path(f"effdet_{CHOSEN_ARCHITECTURE}_no_barlow_V{VERSION}.pth")
MODEL_BARLOW_NAME = Path(f"effdet_{CHOSEN_ARCHITECTURE}_barlow_V{VERSION}.pth")
MODEL_BACKUP_DIR = RESULTS_DIR / Path("model_backup")
BACKBONE_NAME = Path(f"backbone_{CHOSEN_ARCHITECTURE}_V{VERSION}.pth")
